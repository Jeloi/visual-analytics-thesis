...
// Holds all the data, binned by hour (index is hour_index)
hours_data = [];

// Holds the count for each hour_index (index is hour_index)
hour_counts = [];


day_data = [];

// Holds arrays, each representing one day's worth of microblogs
all_data = [];
// Holds an array represeting the "by hour" grouped values of microblogs for each day
daychart_data = []